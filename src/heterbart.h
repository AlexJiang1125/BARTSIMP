...
public:
  ...
  double draw_sigmaupdate(double *sigma, rn& gen, double nu, double lambda, double &kappa, double &sigma_m, double &mlik);
  void draw_test(double *sigma, rn& gen, double &kappa, double &sigma_m);
